...
private:
    ...
    OribitCamera camera{glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.f, 1.f, 0.f), 3.0f, 1.0f, 0.f, 0.f};
    ...
    void setup() {
        ...
        // shader
        shader.loadFromfile("shaders/04_shaders/4_1_2_depth_test_display.vert", "shaders/04_shaders/4_1_2_depth_test_display.frag");
...
int main() {
    DepthTest app(800, 600, "depth test display");
    app.run();
    return 0;
}